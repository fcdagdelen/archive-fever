...
summary: |
  The prevailing term in AI tooling is "context engineering" — but this framing assumes one person can know in advance what the relevant context is. Context gardening starts from a different premise: you don't manufacture context, you cultivate the conditions for it to grow.
---
...
The most powerful context for AI is the one that no single person designed — the kind that can only emerge from the collective intelligence of the people who produced it. [[egregore|Egregore]] is the environment where that emergence happens.
