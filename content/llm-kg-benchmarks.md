...
summary: |
  Comprehensive survey of 47 benchmarks across relation extraction, link prediction, schema evolution, and multi-hop reasoning reveals that fine-tuned 7B models now outperform zero-shot GPT-4, while a critical gap exists in dynamic ontology mutation benchmarks.
---
...
- [[memory-architectures-frontier-ai]] — Memory systems reveal divergent design philosophies
- [[psyche-polis]] — Dynamic ontology mutation for navigable cities
